        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">
                    @isset($fontawsome)
                        <i class="{{ $fontawsome }} text-dark me-2"></i>
                    @endisset
                    {{ Str::title(array_key_last($links)) }}
                </h1>
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    @foreach ($links as $link_name => $link_route)
                        @if (!$loop->last)
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route($link_route) }}" class="text-muted text-hover-primary">{{ Str::title($link_name) }}</a>
                            </li>
                            <!--end::Item-->
                        @else
                        <!--begin::Item-->
                            <li class="breadcrumb-item text-dark">{{ Str::title($link_name) }}</li>
                        <!--end::Item-->
                        @endif
