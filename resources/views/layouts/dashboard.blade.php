...
<body id="kt_body"
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item @yield('product_management') menu-accordion mb-1">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    <div class="menu-item">
                                        <a class="menu-link @yield('unit.index')" href="{{ route('unit.index') }}">
                                            <span class="menu-bullet">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    <div class="menu-item">
                                        <a class="menu-link @yield('expense.create')" href="{{ route('expense.create') }}">
                                            ...
                                            <span class="menu-title">Print Barcode</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            @can('can manage store')
                                <div class="menu-item">
                                    <a class="menu-link @yield('currency.index')" href="{{ route('currencies.index') }}">
                                        <span class="menu-icon">
                            ...
                            @can('can manage expense')
                                <div data-kt-menu-trigger="click"
                                    class="menu-item @yield('expense_management') menu-accordion mb-1">
                                    <span class="menu-link">
                                        <span class="menu-icon">
                            ...
                            @canany(['can add user', 'can see user list', 'can role user', 'can see role list'])
                                <div data-kt-menu-trigger="click"
                                    class="menu-item @yield('user_management') menu-accordion mb-1">
                                    <span class="menu-link">
                                        <span class="menu-icon">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            <a href="../../demo1/dist/index.html" class="d-lg-none">
                                <img alt="Logo" src="{{ asset('dashboard_assets') }}/media/logos/logo-2.svg"
                                    class="h-30px" />
                            </a>
                        </div>
                        <!--end::Mobile logo-->
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
                                        ...
                                        <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10"
                                            style="background-image:url('{{ asset('dashboard_assets') }}/media/misc/pattern-1.jpg')">
                                            <!--begin::Title-->
                                            ...
                                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="../../demo1/dist/account/settings.html"
                                                        ...
                                                        <span class="symbol symbol-20px me-4">
                                                            <img class="rounded-1"
                                                                src="{{ asset('dashboard_assets') }}/media/flags/spain.svg"
                                                                alt="" />
                                                        </span>Spanish</a>
                                                </div>
                                                <!--end::Menu item-->
    ...
    <div class="engage-toolbar d-flex position-fixed px-5 fw-bolder zindex-2 top-50 end-0 transform-90 mt-20 gap-2">
        <!--begin::Purchase link-->
        <a href="#" target="_blank"
            class="engage-purchase-link btn btn-color-gray-700 bg-body btn-active-color-gray-900' btn-flex h-35px px-5 shadow-sm rounded-top-0">Point
            of Sale (POS)</a>
        <!--end::Purchase link-->
    </div>
    <!--end::Engage toolbar-->
