            ...
            <form class="form fv-plugins-bootstrap5 fv-plugins-framework" wire:submit.prevent="save">
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-8">
                        <div class="fv-row col-lg-4">
                            ...
                            <select wire:model="country_id" class="form-select">
                                ...
                                @foreach ($countries as $country)
                                    <option {{ $country->id == $country_id ? 'selected' : '' }}
                        ...
                        <div class="fv-row col-lg-4">
                            <!--begin::Label-->
                            <label class="fs-6 fw-bold mb-2">Timezone</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select wire:model="timezone" class="form-select">
                                @foreach ($timezones as $timezone)
                                    <option @if ($timezone == $timezone->code) selected @endif
                                        value="{{ $timezone->code }}">{{ $timezone->code }}
                                    </option>
                                @endforeach
                            </select>
                            <!--end::Input-->
